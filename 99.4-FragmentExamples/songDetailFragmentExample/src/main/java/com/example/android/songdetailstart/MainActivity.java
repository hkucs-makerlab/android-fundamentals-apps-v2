...
https://codelabs.developers.google.com/codelabs/advanced-android-training-fragment-communication/#3
 -- an app to a master/detail layout using fragment

*/


/**
 * MainActivity representing a list of song titles (items). When one is
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // there are two layout of song_list - one for 900dp ; one for normal
        ...
        // the container only found in 900dp song_list layout
    ...
    class SimpleItemRecyclerViewAdapter extends RecyclerView.Adapter
        ...
        class ViewHolder extends RecyclerView.ViewHolder {
            ...
            // passed View is layout containing two TextView
