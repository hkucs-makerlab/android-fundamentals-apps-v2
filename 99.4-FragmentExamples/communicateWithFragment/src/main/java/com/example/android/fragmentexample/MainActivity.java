...
/*
    ...
    01.2: Fragment communication
    - is a dynamtic fragment example
    - onAttach() of fragment passed the context of Activity to communicate
    - setArguments()/getArguments of fragment passed a bundle for a set of value
 */

public class MainActivity extends AppCompatActivity implements View.OnClickListener,SimpleFragment.OnFragmentInteractionListener {
